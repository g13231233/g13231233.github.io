document.addEventListener('DOMContentLoaded', function() {
    ...
    const cards = [
        ...
        { name: '黄金[坐牢]', description: '本局没有任何海克斯效果，可以在任何一回合随机偷一张牌，也可以放弃偷牌。', rarity: 'gold', probability: 0.3 },
        { name: '棱彩[坐牢]', description: '本局没有任何海克斯效果，重置所有人的海克斯科技。', rarity: 'vibrant', probability: 0.1 },

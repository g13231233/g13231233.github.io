document.addEventListener('DOMContentLoaded', function() {
    ...
    const cards = [
        ...
        { name: '💜棱彩💜[军火商]', description: '可以使用5积分当作无敌炸弹，1局能使用3次。', rarity: 'vibrant', probability: 0.1 },
        ...
        { name: '💛黄金💛[拆卸器]', description: '把上家和下家的海克斯科技全部拆走自己用。', rarity: 'gold', probability: 0.3 },
        ...
        { name: '🖤白银🖤[盗版炸弹]', description: '任意3张牌当炸弹用，只能用来炸普通牌，对正版炸弹不生效。1局只能使用1次。', rarity: 'silver', probability: 0.6 },
        { name: '💛黄金💛[盗版炸弹]', description: '任意3张牌当炸弹用，对正版炸弹生效，永远比正版炸弹大1个级别。1局只能使用1次。', rarity: 'gold', probability: 0.3 },
        { name: '💜棱彩💜[盗版炸弹]', description: '任意3张牌当炸弹用，比王炸大，但比军火商的无敌炸弹弱。1局只能使用1次。', rarity: 'vibrant', probability: 0.1 },
        ...
        { name: '🖤白银🖤[制裁者]', description: '本局第1个出炸弹的人你可以随机抽他手中1张牌自己用，1局只能抽1次。', rarity: 'silver', probability: 0.6 },
        { name: '💛黄金💛[制裁者]', description: '本局第1个出炸弹的人你可以随机抽他手中2张牌自己用，1局只能抽1次。', rarity: 'gold', probability: 0.3 },
        { name: '💜棱彩💜[制裁者]', description: '本局第1个出炸弹的人你可以随机抽他手中3张牌自己用，1局只能抽1次。', rarity: 'vibrant', probability: 0.1 },

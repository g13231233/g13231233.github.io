document.addEventListener('DOMContentLoaded', function() {
    ...
    const cards = [
        ...
        { name: '🖤白银🖤[禁言]', description: '禁止出牌1回合，1回合后从已出牌库中任选1张牌，也可不选。', rarity: 'silver', probability: 0.6 },
        { name: '💛黄金💛[禁言]', description: '禁止出牌2回合，2回合后从已出牌库中任选2张牌，也可不选。', rarity: 'gold', probability: 0.3 },
        { name: '💜棱彩💜[禁言]', description: '禁止出牌3回合，3回合后从已出牌库中任选3张牌，也可不选。', rarity: 'vibrant', probability: 0.1 },

document.addEventListener('DOMContentLoaded', function() {
    ...
    const cards = [
        ...
        { name: '🖤白银🖤[炒冷饭]', description: '本局可以在已出的牌库中选1张牌。', rarity: 'silver', probability: 0.6 },
        { name: '💛黄金💛[炒冷饭]', description: '本局可以在已出的牌库中选2张牌。', rarity: 'gold', probability: 0.3 },
        { name: '💜棱彩💜[炒冷饭]', description: '本局可以在已出的牌库中选3张牌。', rarity: 'vibrant', probability: 0.1 },
        ...
        { name: '🖤白银🖤[走为上策]', description: '第3个出完牌的话，积分另外加5。', rarity: 'silver', probability: 0.6 },
        { name: '💛黄金💛[走为上策]', description: '第3个出完牌的话，积分另外加10。', rarity: 'gold', probability: 0.3 },
        { name: '💜棱彩💜[走为上策]', description: '第3个出完牌的话，积分另外加20。', rarity: 'vibrant', probability: 0.1 },
        ...
        { name: '💛黄金💛[模仿秀]', description: '任何时候都可以模仿1次其他人出的牌，比如：其他人出345，自己也可以随时打出345。', rarity: 'gold', probability: 0.3 },
        { name: '💜棱彩💜[模仿秀]', description: '任何时候都可以模仿1次其他人出的牌，比如：其他人出345，自己也可以随时打出345。', rarity: 'vibrant', probability: 0.1 },
        ...
        { name: '💛黄金💛[盗版炸弹]', description: '任意3张牌当炸弹用，只能用来炸普通牌，对正版炸弹不生效。一局只能使用2次。', rarity: 'gold', probability: 0.3 },
        { name: '💜棱彩💜[盗版炸弹]', description: '任意3张牌当炸弹用，只能用来炸普通牌，对正版炸弹不生效。一局只能使用3次。', rarity: 'vibrant', probability: 0.1 },
